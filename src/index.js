...
SceneLoader.ImportMesh("", "public/", "mill.glb", scene, function (newMeshes) {
  // Set the target of the camera to the first imported mesh
  newMeshes[0].scaling = new Vector3(0.2, 0.2, 0.15);
  newMeshes[0].rotate(new Vector3(-1, 0, 0), Math.PI / 2);
  newMeshes[0].position.z = -2;
  newMeshes[0].position.x = 2.5;
  //newMeshes[0].position.y = 2.5;
  freza = newMeshes[0];
});
